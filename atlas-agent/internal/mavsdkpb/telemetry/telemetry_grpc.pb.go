...
const (
	...
	TelemetryService_SetRateRawGps_FullMethodName                        = "/mavsdk.rpc.telemetry.TelemetryService/SetRateRawGps"
...
type TelemetryServiceClient interface {
	...
	SetRateRawGps(ctx context.Context, in *SetRateRawGpsRequest, opts ...grpc.CallOption) (*SetRateRawGpsResponse, error)
...
func (c *telemetryServiceClient) SetRateRawGps(ctx context.Context, in *SetRateRawGpsRequest, opts ...grpc.CallOption) (*SetRateRawGpsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetRateRawGpsResponse)
	err := c.cc.Invoke(ctx, TelemetryService_SetRateRawGps_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TelemetryServiceServer interface {
	...
	// Set rate to 'Raw GPS' updates.
	SetRateRawGps(context.Context, *SetRateRawGpsRequest) (*SetRateRawGpsResponse, error)
	// Set rate to 'battery' updates.
...
func (UnimplementedTelemetryServiceServer) SetRateRawGps(context.Context, *SetRateRawGpsRequest) (*SetRateRawGpsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetRateRawGps not implemented")
}
...
func _TelemetryService_SetRateRawGps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRateRawGpsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).SetRateRawGps(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_SetRateRawGps_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).SetRateRawGps(ctx, req.(*SetRateRawGpsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TelemetryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetRateRawGps",
			Handler:    _TelemetryService_SetRateRawGps_Handler,
		},
		{
