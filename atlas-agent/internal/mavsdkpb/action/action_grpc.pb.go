...
const (
	...
	ActionService_SetRelay_FullMethodName                  = "/mavsdk.rpc.action.ActionService/SetRelay"
...
func (c *actionServiceClient) SetRelay(ctx context.Context, in *SetRelayRequest, opts ...grpc.CallOption) (*SetRelayResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetRelayResponse)
	err := c.cc.Invoke(ctx, ActionService_SetRelay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionServiceClient) SetGpsGlobalOrigin(ctx context.Context, in *SetGpsGlobalOriginRequest, opts ...grpc.CallOption) (*SetGpsGlobalOriginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetGpsGlobalOriginResponse)
	err := c.cc.Invoke(ctx, ActionService_SetGpsGlobalOrigin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedActionServiceServer) SetRelay(context.Context, *SetRelayRequest) (*SetRelayResponse, error) {
...
func _ActionService_SetRelay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRelayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActionServiceServer).SetRelay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActionService_SetRelay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActionServiceServer).SetRelay(ctx, req.(*SetRelayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ActionService_SetGpsGlobalOrigin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetGpsGlobalOriginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActionServiceServer).SetGpsGlobalOrigin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActionService_SetGpsGlobalOrigin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActionServiceServer).SetGpsGlobalOrigin(ctx, req.(*SetGpsGlobalOriginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ActionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetRelay",
			Handler:    _ActionService_SetRelay_Handler,
		},
		{
