...
| --- | --- | --- |
| `OpenSession` | Registration, heartbeat, telemetry, status text, command updates, and mission-run updates | Registration acceptance, command requests/cancellations, and mission operations |
